...
function baiduMap(contentId,pointX,pointY,mapTitle,mapContent){
    ...
    //创建地图函数：
    function createMap(){
        var map = new BMap.Map(contentId);//在百度地图容器中创建一个地图
    ...
    //var markerArr = [{title:"三元桥营运中心",content:"北京市朝阳区东三环北路戊2号国际港D座1003室",point:"116.465057|39.964355",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}]
