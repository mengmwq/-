    ...
    function box() {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                d.push(
                    `<img src="${data1.banner}" alt="" class="img-responsive" style="width: 100%;">`
                )
                ...
                dataCrr.push(
                    `<img src="${data1.picture2}" alt="" class="img-responsive">`
                )
                $("#pppp").html(dataCrr.join(''))
                dataDrr.push(
                    `<img src="${data1.picture3}" alt="" class="img-responsive">`
                )
                $("#qyys").html(dataDrr.join(''))

                $.each(r, function (i, k) {
                    data.push(
                        `<div class="col-md-3 col-md-offset-2 col-sm-6  honor ">`,
